  ...
  return (
    <section className="download-bg grid">
      ...
      <div className="download-store">
        <a href='https://play.google.com/store/apps?hl=en_GB&gl=Uk' rel="noopener noreferrer" target='_blank' ><img src={google} alt="google store" /></a>
        <a href='https://www.apple.com/uk/app-store/' rel="noopener noreferrer" target='_blank' ><img src={apple} alt="apple store" /></a>                   
      </div>
